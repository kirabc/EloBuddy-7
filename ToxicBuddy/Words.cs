...
namespace ToxicBuddy
{
    class Words
    {
        public static List<string> WordList = new List<string>{ "4r5e", "5h1t", "5hit", "a55", "anal", "anus", "ar5e", "arrse", "arse", "ass", "ass-fucker", "asses", "assfucker",
            ...
            "whore", "willies", "willy", "xrated", "xxx", "scripter", "hacker", "haxor", "hacks", "hack", "scripts", "cheats", "gay", "gayboy" };
    }
}
